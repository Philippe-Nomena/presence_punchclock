...
namespace Presence.Controllers
{
    public class OrganisationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom_Organisation")] Organisation organisation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom_Organisation")] Organisation organisation)
        {
